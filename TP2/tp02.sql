-- ============================================================
--   Nom de la base   :  BD_Notation
--   Nom de SGBD      :  ORACLE 
--   Date de création :  Mars 2020 
--   Auteur           :  Abdelkrim LAHLOU
-- ============================================================
...
-- Ajouter les contraintes de cles etrangeres

REM  ALTER TABLE Epreuve ADD CONSTRAINT FkEpreuve1 FOREIGN KEY(CodeMat) REFERENCES
REM  Matiere(CodeMat);
...
create user Apprenti identified by M1appLSI
...
GRANT ALTER SESSION TO Apprenti;
GRANT CREATE DATABASE LINK TO Apprenti;
GRANT CREATE SYNONYM TO Apprenti;
GRANT CREATE VIEW TO Apprenti;
GRANT CREATE TRIGGER TO Apprenti;
GRANT DEBUG CONNECT SESSION TO Apprenti;
GRANT UNLIMITED TABLESPACE TO Apprenti;
GRANT CONNECT TO Apprenti;
GRANT RESOURCE TO Apprenti;
GRANT SELECT_CATALOG_ROLE TO Apprenti;
